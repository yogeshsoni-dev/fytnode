...
import {
  LayoutDashboard, Users, UserCheck, CreditCard, CalendarCheck,
  Bell, LogOut, Zap
} from 'lucide-react';
...
const NAV = [
  ...
  { to: '/subscriptions', icon: CreditCard,       label: 'Subscriptions', roles: ['admin', 'member'] },
  { to: '/trainers',      icon: UserCheck,        label: 'Trainers',      roles: ['admin'] },
  { to: '/notifications', icon: Bell,             label: 'Notifications', roles: ['admin', 'trainer'] },
];
  ...
  return (
    <aside style={S.sidebar}>
      ...
      <div style={S.userCard}>
        <div style={{ ...S.userAvatar, background: AVATAR_COLORS[currentUser?.role] || AVATAR_COLORS.member }}>
